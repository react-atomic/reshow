...
describe("Test build react", () => {
  it("test with null props", () => {
    const wrap = render(
      /**@type React.ReactElement*/ (build("div")(null, <span />))
    );
    expect(wrap.html()).to.equal("<div><span></span></div>");
  });
  it("test with undefined props", () => {
    const wrap = render(
      /**@type React.ReactElement*/ (build("div")(undefined, <span />))
    );
    expect(wrap.html()).to.equal("<div><span></span></div>");
  });
  it("should have same behavior with createElement", () => {
    expect(
      render(/**@type React.ReactElement*/ (build("div")(null, "span"))).html()
    ).to.equal(render(createElement("div", null, "span")).html());
  });
  it("should have same behavior with cloneElement", () => {
    ...
    ).to.equal(render(cloneElement(<div />, undefined, "span")).html());
  });
});
